...
if __name__ == "__main__":
    ref_path_160 = "/media/media01/ybmiao/output/EMB/7_22/Ins160/box_ref.txt"
    ref_path_335 = "/media/media01/ybmiao/output/EMB/7_22/Ins335/box_ref.txt"
    ref_path_335 = "/media/media01/ybmiao/output/Exhaust/cutler/Ins335/box_ref.txt"
    ref_path_instre = "/media/media01/ybmiao/output/EMB/7_22/instre/box_ref.txt"
    ...
    # ref_path = "/media/media01/qysun/results/ksum/1106_new_nopurity/Ins160/box_ref.txt"
    # ref_path = "/media/media01/qysun/results/ksum/1107/Ins160/box_ref.txt"
    # ref_path = "/media/media01/qysun/results/ksum/1107/Ins160/box_ref.txt"
    # ref_path = "/media/media01/ybmiao/output/kcut/10_20/Ins160/box_ref.txt"
    # ref_path = "/media/media01/qysun/results/ksum/1107_fixkey/instre/box_ref.txt"
    # ref_path = "/media/media01/ybmiao/output/kcut/10_20/Ins335/box_ref.txt"
    # ref_path = "/media/media01/ybmiao/output/kcut/10_20/instre/box_ref.txt"
    # ref_path = "/media/media01/ybmiao/output/kcut/10_20/Ins160/box_ref.txt"
    ref_path = "/media/media01/ybmiao/output/kcut/12_07/Ins335/box_ref.txt"
    # ref_path = "/media/media01/ybmiao/output/Exhaust/cutler/instre/box_ref.txt"
