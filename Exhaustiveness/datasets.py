...
class Dataset:
    def __init__(self, dataset_name, dataset_set, remove_hards):
        ...
        if dataset_name == "VOC07":
            ...
            self.year = "2017"
            self.root_path = "/home/ybmiao/data/coco/images/val2017"
            self.sel20k = '/media/media01/qysun/data/coco/coco_val2017_filename.txt'
            # JSON file constructed based on COCO train2014 gt 
            # self.all_annfile = "/media/media01/jfwang/data/coco/annotations/instances_val2017.json"
            # # self.annfile = "/media/media01/jfwang/data/coco/instances_val2017_sel20k.json"
            # self.annfile = "/media/media01/jfwang/data/coco/annotations/instances_val2017.json"
            self.all_annfile = "/home/ybmiao/data/coco/annotations/instances_val2017.json"
            # self.annfile = "/media/media01/jfwang/data/coco/instances_val2017_sel20k.json"
            self.annfile = "/home/ybmiao/data/coco/annotations/instances_val2017.json"
            ...
            self.val2017 = get_val2017(self.all_annfile)
        else:
    ...
    def load_image(self, im_name):
        ...
        if "VOC" in self.dataset_name:
            ...
            image = skimage.io.imread(f"/home/jfwang/data/coco/images/val2017/{im_name}")
        else:
    ...
    def get_image_name(self, inp):
        ...
        if "VOC" in self.dataset_name:
            ...
            im_name = self.val2017['images'][self.sel_20k.index(im_name)]['file_name']
...
def select_coco_20k(sel_file, all_annotations_file):
    ...
    with open("/media/media01/jfwang/data/coco/instances_val2017_sel20k.json", "w") as outfile:
