...
from yb_utils import get_bboxes_from_file, get_CUHK_SYSU_bboxes_from_file,\
    calculate_resized_w_h, load_config_file, load_mask, load_roi_mask,\
...
class Feature_Extraction():
    def __init__(self, config_path="/home/ybmiao/code/EMB/feature_extraction/configs.yaml", use_config=True, show_info=True,
        ...
        self.CUHK_SYSU_img_qry = "/media/media01/qysun/data/CUHK-SYSU/INS/INS_CUHK_SYSU_query.txt"
        self.holidays_img_qry = "/media/media01/qysun/data/holidays/holidays_qry_all.txt"
        self.oxford_img_qry = "/media/media01/qysun/data/oxford/qry.txt"
        self.paris_img_qry = "/media/media01/qysun/data/paris/qry.txt"
        ...
        self.CUHK_SYSU_img_ref = "/media/media01/qysun/data/CUHK-SYSU/INS/INS_CUHK_SYSU_gallery.txt"

        # os.environ["CUDA_VISIBLE_DEVICES"] = str(selsf.gpu)
    ...
    def load_mmaskes(self, pic_name,raw_img,boxes, is_qry=None):
        ...
        # get label
        if self.dataset == "Ins160" or self.dataset == "Ins335" or self.dataset == "CUHK-SYSU" or self.dataset == "oxford" or self.dataset == "paris" or self.dataset == "holidays":
            label = pic_name
        ...
        # 给出一个
        if is_qry and self.dataset != "CUHK-SYSU":
    ...
    def method_maskroi(self, layer, boxes, rate, pooling, pic_name, raw_img, is_qry=None):
        ...
        for box_idx, box in enumerate(boxes):
            ...
            mmask = downsample_mask(mmask, h=feature_map.shape[-2], w=feature_map.shape[-1], min_num=3)
                ...
                for layer in self.layers:
                    for pooling in self.pooling:
                        ...
                        if method == 'roi':
                            ...
                            if is_qry and (self.dataset == "Ins160" or self.dataset == "Ins335"):
                                features, boxes_list = self.method_roi(layer,boxes,rate,pooling, pic_name,raw_img, is_qry)
                            else:
                                features, boxes_list = self.method_maskroi(layer, boxes, rate, pooling, pic_name, raw_img,
                                                                       is_qry)
    ...
    def extract_qry(self):
        ...
        elif self.dataset == "CUHK-SYSU":
            file_name = self.CUHK_SYSU_img_qry
        elif self.dataset == "oxford":
            file_name = self.oxford_img_qry
        elif self.dataset == "paris":
            file_name = self.paris_img_qry
        elif self.dataset == "holidays":
            file_name = self.holidays_img_qry
        else:
            raise ValueError("Wrong dataset choose in config.yaml. Please input Ins160/ Ins335/ instre !")

        if self.dataset == "Ins160" or self.dataset == "Ins335" or self.dataset == "instre" or self.dataset == "oxford" or self.dataset == "paris":
            names, file_boxes = get_bboxes_from_file(file_name)
        elif self.dataset == "CUHK-SYSU":
            names, file_boxes = get_CUHK_SYSU_bboxes_from_file(file_name)
        # elif self.dataset == "holidays":
        #     names, file_boxes = get_Holidays_bboxes_from_file(file)
        else:
            raise ValueError("Wrong dataset choose in config.yaml. Please input Ins160/ Ins335/ instre !")
        file_names = []
        for name in names:
            ...
            if self.dataset == "Ins160":
                ...
                nn = '/home/ybmiao/data/CUHK-SYSU/Image/SSM/' + str(name) + '.jpg'
            elif self.dataset == "oxford":
                nn = '/home/ybmiao/data/oxford/oxbuild_images/' + str(name) + '.jpg'
            elif self.dataset == "instre":
...
parse.add_argument('--show_info', default=True, action='store_true')
...
# parse.add_argument('--dataset', type=str, default='holidays')
# parse.add_argument('--box_path', type=str, default='/media/media01/ybmiao/output/kcut/3_21/holidays/box_ref.txt')
# parse.add_argument('--save_path', type=str, default='/media/media01/ybmiao/output/kcut/3_21/holidays/test')
parse.add_argument('--dataset', type=str, default='oxford')
parse.add_argument('--box_path', type=str, default='/media/media01/ybmiao/output/kcut/3_21/oxford/box_ref.txt')
parse.add_argument('--save_path', type=str, default='/media/media01/ybmiao/output/kcut/3_21/oxford/test')
...
# parse.add_argument('--dataset', type=str, default='Ins160')
# parse.add_argument('--box_path', type=str, default='/home/ybmiao/output/kcut/12_07/Ins160/box_ref.txt')
# parse.add_argument('--save_path', type=str, default='/home/ybmiao/output/kcut/12_07/Ins160/test')
# parse.add_argument('--dataset', type=str, default='Ins160')
...
# parse.add_argument('--dataset', type=str, default='Ins335')
# parse.add_argument('--box_path', type=str, default='/home/ybmiao/output/kcut/10_20/Ins335/box_ref.txt')
# parse.add_argument('--save_path', type=str, default='/home/ybmiao/output/kcut/10_20/Ins335/test')
...
parse.add_argument('--para', type=str, default='swav')  # swav
parse.add_argument('--mode', type=str, default='all')  # qry / ref / all
# parse.add_argument('--mode', type=str, default='ref')  # qry / ref / all
...
# parse.add_argument('--methods', type=str, nargs='+', default=['roi', 'mask_roi'])
# parse.add_argument('--methods', type=str, nargs='+', default=['roi','mask_roi'])
